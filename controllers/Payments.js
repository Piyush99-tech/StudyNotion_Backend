...
exports.capturePayment = async (req, res) => {
    ...
    console.log("i am inside capture payment");
...
console.log("REQ USER: ", req.user);
    ...
    for(const course_id of courses){
        ...
        try{
            ...
            const uid = new mongoose.Types.ObjectId(userId);//JavaScript is doing a strict equality (===) comparison. 
            // It does not convert types. So a string and an ObjectId will not match, even if they look the same:
